    ...
    return /* @__PURE__ */ u2("div", { class: classNames("toc"), children: [
      /* @__PURE__ */ u2(
        "button",
        {
          ...
          children: /* @__PURE__ */ u2("h3", { children: i18n(cfg.locale).components.tableOfContents.title })
        }
      ),
      /* @__PURE__ */ u2(
        OverflowList2,
        {
          ...
          children: fileData.toc.map((tocEntry) => {
            const slug2 = String(tocEntry.slug);
            const depth = String(tocEntry.depth);
            const text = String(tocEntry.text);
            return /* @__PURE__ */ u2("li", { class: `depth-${depth}`, children: /* @__PURE__ */ u2("a", { href: `#${slug2}`, "data-for": slug2, children: text }) }, slug2);
          })
        }
      )
    ] });
